...
if __name__ == "__main__":  
    ...
    path = 'Ultra_light_fr/main/images/known'#Path of known images to compare from
    ...
    with open("Ultra_light_fr/encodings.json", 'r+') as f:
        data = json.load(f)
    ...
    frame = cv2.imread("Ultra_light_fr/main/images/unknown/ross1.jpeg")
